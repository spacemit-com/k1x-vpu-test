...
enum mvx_argp_action { MVX_ARGP_STORE, MVX_ARGP_APPEND };
 ...
 */
int mvx_argp_add_opt(struct mvx_argparse *argp, const char arg_short,
 ...
 */
int mvx_argp_add_pos(struct mvx_argparse *argp, const char *arg_long,
