...
{
public:
    IO(uint32_t format, bool preload = 0, size_t width = 0, size_t height = 0, size_t strideAlign = 0);
    virtual ~IO() {}
...
{
public:
    Input(uint32_t format, bool preload = 0, size_t width = 0, size_t height = 0, size_t strideAlign = 0);
...
protected:
    InputFile(std::istream &input, uint32_t format, size_t width, size_t height, size_t strideAlign, bool preload = 0);
...
{
public:
    InputAFBC(std::istream &input, uint32_t format, size_t width, size_t height, bool preload);
...
{
public:
    InputFileFrame(std::istream &input, uint32_t format, size_t width, size_t height, size_t strideAlign, bool preload = 0);
...
public:
    InputFileFrameWithROI(std::istream &input, uint32_t format,
                        size_t width, size_t height, size_t strideAlign, std::istream &roi);
    virtual void prepare(Buffer &buf);
...
public:
    InputFileFrameWithEPR(std::istream &input, uint32_t format,
                        size_t width, size_t height, size_t strideAlign, std::istream &epr, uint32_t oformat);
...
{
public:
    OutputFileWithMD5(std::ofstream &output, uint32_t format, std::ofstream &output_md5, std::ifstream* md5ref);
    virtual void finalize(Buffer &buf);
