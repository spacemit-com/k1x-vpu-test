...
#DESCRIPTION: validate_mvx_notify_device should return true if
#DESCRIPTION: all pointers are non-null
*/
...
int main(int argc, char **argv) {
  ...
  /* Create a fake data-ptr */
  data = (void *)&data;
  /* Create a fake device-ptr that is null. */
  test_ptr = (struct device *)&test_ptr;

  if (true == validate_mvx_notify_device(test_ptr, data) && true == evaluated) {
    reply = 0;
  }
