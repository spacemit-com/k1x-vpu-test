...
#DESCRIPTION: mvx_bus_walker should validate the driver-data ptr for the source.
*/
...
int main(int argc, char** argv) {
  ...
  struct driver driver;
  struct mvx_discovery_target source_discovery_target;
  ...
  source_discovery_target.notify = NULL;
  source.drvdata = &source_discovery_target;
  source.driver = NULL;
  source.drvdata = NULL;
